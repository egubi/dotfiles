# Generated by Powerlevel10k configuration wizard on 2023-12-07 at 11:10 +08.
...
() {
  ...
  typeset -g POWERLEVEL9K_ANACONDA_CONTENT_EXPANSION='${${CONDA_DEFAULT_ENV//\%/%%}:+${${(&):-${CONDA_DEFAULT_ENV}%% }}[1]} ${P9K_ANACONDA_PYTHON_VERSION}'
  ...
  typeset -g POWERLEVEL9K_HASKELL_STACK_PROMPT_ALWAYS_SHOW=false

  ###########[ kubecontext ]###########
  typeset -g POWERLEVEL9K_KUBECONTEXT_SHOW_ON_COMMAND='kubectl|helm|kubens|kubectx|oc|istioctl|kogito|k9s|helmfile|flux|fluxctl|stern|kubeseal|skaffold|kubent|kubecolor|cmctl|turbulent'
  typeset -g POWERLEVEL9K_KUBECONTEXT_CLASSES=(
    '*prod*'    PROD
    '*staging*' STAGING
    '*'         DEFAULT)
  typeset -g POWERLEVEL9K_KUBECONTEXT_PROD_FOREGROUND=9
  typeset -g POWERLEVEL9K_KUBECONTEXT_STAGING_FOREGROUND=220
  ...
  #############[ aws ]#############
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|awless|cdk|sam'
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
    '*prod*'    PROD
    '*staging*' STAGING
    '*'         DEFAULT)
  typeset -g POWERLEVEL9K_AWS_PROD_FOREGROUND=9
  typeset -g POWERLEVEL9K_AWS_STAGING_FOREGROUND=220
  ...
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_CLASSES=(
    '*prod*' PROD
    '*'      DEFAULT)
  typeset -g POWERLEVEL9K_GOOGLE_APP_CRED_PROD_FOREGROUND=9
  ...
  # Trim prompt when a command is accepted.
  typeset -g POWERLEVEL9K_TRANSIENT_PROMPT=always

  # Instant prompt mode.
  typeset -g POWERLEVEL9K_INSTANT_PROMPT=verbose

  # Disable hot reload for faster prompt.
